...
// Generated Fri May 8 07:00:23 2026
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('opt_floorplan', 2, true);
	...
	this.addSkin=function() {
		...
		me._controller.logicBlock_position = function() {
			...
			if (me._controller.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._controller.ggCurrentLogicStatePosition == 0) {
					...
					me._controller.ggDx=18;
					me._controller.style.bottom='27px';
					me._controller.ggUpdatePosition(true);
				}
			}
		}
		...
		me._controller_bg.logicBlock_size = function() {
			...
			if (me._controller_bg.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				else if (me._controller_bg.ggCurrentLogicStateSize == 8) {
					me._controller_bg.style.width='338px';
					me._controller_bg.style.height='50px';
					skin.updateSize(me._controller_bg);
				}
				else {
					me._controller_bg.style.width='380px';
					me._controller_bg.style.height='50px';
					skin.updateSize(me._controller_bg);
				}
			}
		...
		me._controller_slider.logicBlock_position = function() {
			...
			if (me._controller_slider.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._controller_slider.ggCurrentLogicStatePosition == 0) {
					...
					me._controller_slider.style.left='7px';
					me._controller_slider.style.top='0px';
				}
			}
		}
		...
		me._floorplan_button.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('opt_floorplan') == 0)
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._floorplan_button.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._floorplan_button.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._floorplan_button.style[domTransition]='';
				if (me._floorplan_button.ggCurrentLogicStateVisible == 0) {
					me._floorplan_button.style.visibility=(Number(me._floorplan_button.style.opacity)>0||!me._floorplan_button.style.opacity)?'inherit':'hidden';
					me._floorplan_button.ggVisible=true;
				}
				else {
					me._floorplan_button.style.visibility=(Number(me._floorplan_button.style.opacity)>0||!me._floorplan_button.style.opacity)?'inherit':'hidden';
					me._floorplan_button.ggVisible=true;
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		ela=me._thumbnail_hide_button_show__imga=document.createElement('img');
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		me._thumbnail_hide_button_show__imga.setAttribute('src',hs);
		ela.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;thumbnail_hide_button_show;');
		ela['ondragstart']=function() { return false; };
		el.appendChild(ela);
		...
		me._thumbnail_hide_button_show.onmouseout=function (e) {
			...
			me._thumbnail_hide_button_show__imga.style.visibility='hidden';
		}
		me._thumbnail_hide_button_show.onmousedown=function (e) {
			me._thumbnail_hide_button_show__imga.style.visibility='inherit';
			me._thumbnail_hide_button_show__imgo.style.visibility='hidden';
		}
		me._thumbnail_hide_button_show.onmouseup=function (e) {
			me._thumbnail_hide_button_show__imga.style.visibility='hidden';
			me._thumbnail_hide_button_show__imgo.style.visibility='inherit';
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		ela=me._thumbnail_show_button_show__imga=document.createElement('img');
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		me._thumbnail_show_button_show__imga.setAttribute('src',hs);
		ela.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;thumbnail_show_button_show;');
		ela['ondragstart']=function() { return false; };
		el.appendChild(ela);
		...
		me._thumbnail_show_button_show.onmouseout=function (e) {
			...
			me._thumbnail_show_button_show__imga.style.visibility='hidden';
		}
		me._thumbnail_show_button_show.onmousedown=function (e) {
			me._thumbnail_show_button_show__imga.style.visibility='inherit';
			me._thumbnail_show_button_show__imgo.style.visibility='hidden';
		}
		me._thumbnail_show_button_show.onmouseup=function (e) {
			me._thumbnail_show_button_show__imga.style.visibility='hidden';
			me._thumbnail_show_button_show__imgo.style.visibility='inherit';
		}
		...
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 792px; height: 15px; background-color: rgba(0,0,0,0.392157); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._thumbnail_menu__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 792px; height: 15px; background-color: rgba(0,0,0,1); pointer-events: auto;');
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 358px; background-color: rgba(0,0,0,0.392157); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._thumbnail_menu_mobile__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 358px; background-color: rgba(0,0,0,1); pointer-events: auto;');
		...
		me._thumbnail_menu_mobile.logicBlock_position = function() {
			...
			if (me._thumbnail_menu_mobile.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._thumbnail_menu_mobile.ggCurrentLogicStatePosition == 0) {
					...
					me._thumbnail_menu_mobile.style.left='30px';
					me._thumbnail_menu_mobile.ggDy=-66;
					me._thumbnail_menu_mobile.ggUpdatePosition(true);
				}
			}
		}
		...
		el.ggUpdate = function(filter) {
			...
			var row = 0;
			var column = 0;
			var numCols = me._thumbnail_cloner_mobile.ggNumRepeat;
		...
		el=me._floorplan_container=document.createElement('div');
		el.ggId="floorplan_container";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._floorplan_container.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._floorplan_container.logicBlock_size = function() {
			var newLogicStateSize;
			if (
			...
			if (me._floorplan_container.ggCurrentLogicStateSize != newLogicStateSize) {
				me._floorplan_container.ggCurrentLogicStateSize = newLogicStateSize;
				me._floorplan_container.style[domTransition]='width 0s, height 0s';
				if (me._floorplan_container.ggCurrentLogicStateSize == 0) {
					me._floorplan_container.style.width='80%';
					me._floorplan_container.style.height='45%';
					skin.updateSize(me._floorplan_container);
				}
				else {
					me._floorplan_container.style.width='35%';
					me._floorplan_container.style.height='50%';
					skin.updateSize(me._floorplan_container);
				}
			}
		}
		me._floorplan_container.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
			...
			if (me._floorplan_container.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._floorplan_container.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._floorplan_container.style[domTransition]='width 0s, height 0s';
				if (me._floorplan_container.ggCurrentLogicStateVisible == 0) {
					me._floorplan_container.style.visibility=(Number(me._floorplan_container.style.opacity)>0||!me._floorplan_container.style.opacity)?'inherit':'hidden';
					me._floorplan_container.ggVisible=true;
				}
				else {
					me._floorplan_container.style.visibility="hidden";
					me._floorplan_container.ggVisible=false;
				}
			}
		}
		me._floorplan_container.ggUpdatePosition=function (useTransition) {
		}
		...
		me._floorplan_container.appendChild(me._floorplan);
		me.divSkin.appendChild(me._floorplan_container);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
			...
			if (mapType == 'web') {
				...
				if (mapDetails['mapprovider'] == 'openstreetmap') {
					if (mapDetails['mapstyle'] == 'streets') {
						L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{}).addTo(me._floorplan.ggMap);
					} else if (mapDetails['mapstyle'] == 'outdoors') {
						L.tileLayer('http://{s}.tile.opentopomap.org/{z}/{x}/{y}.png',{}).addTo(me._floorplan.ggMap);
					}
		...
		player.addListener('configloaded', function() {
			...
			if (
				(
					(player.getVariableValue('opt_floorplan') == true)
				)
			) {
				player.setVariableValue('pos_controller', player.getVariableValue('pos_controller') + Number("1"));
			}
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'IsNDQsMzQuNzg5eiIvPg0KCQk8Y2lyY2xlIGZpbGw9IiMzOTQyNDAiIGN4PSIzMiIgY3k9IjI0IiByPSI4Ii8+DQoJPC9nPg0KPC9nPg0KPC9zdmc+';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			'';
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.__div.setAttribute('style','position: absolute;width: 96px; height: 105px; visibility: inherit; overflow: visible;');
	...
	function SkinCloner_thumbnail_cloner_mobile_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.elementMouseOver={};
		me.__div=document.createElement('div');
		me.__div.setAttribute('style','position: absolute;width: 128px; height: 86px; visibility: inherit; overflow: visible;');
		me.__div.style.left=parameter.left;
		me.__div.style.top=parameter.top;
		me.__div.ggIsActive = function() {
			return player.getCurrentNode()==me.ggNodeId;
		...
		me._thumbnail_active_mobile.appendChild(me._thumbnail_nodeimage_mobile);
	...
	me._floorplan_container.logicBlock_size();
	...
	me._floorplan_button.logicBlock_visible();
	...
	me._floorplan_container.logicBlock_visible();
	me._rectilinear.logicBlock_alpha();
	me._fisheye.logicBlock_alpha();
	me._stereographic.logicBlock_alpha();
	player.addListener('sizechanged', function(args) { me._screentint.logicBlock_alpha();me._thumbnail_hide_button_show.logicBlock_alpha();me._thumbnail_show_button_show.logicBlock_alpha();me._thumbnail_menu.logicBlock_visible();me._thumbnail_menu.logicBlock_alpha();me._thumbnail_menu_mobile.logicBlock_visible();me._thumbnail_menu_mobile.logicBlock_alpha();me._floorplan_container.logicBlock_size(); });
	...
	player.addListener('varchanged_vis_timer', function(args) { me._controller.logicBlock_alpha();me._thumbnail_menu.logicBlock_alpha(); });
	...
	player.addListener('varchanged_vis_thumbnail_menu_auto_hide', function(args) { me._screentint.logicBlock_alpha();me._thumbnail_menu.logicBlock_alpha(); });
	...
	player.addListener('varchanged_vis_floorplan', function(args) { me._floorplan_container.logicBlock_visible(); });
	...
	player.addListener('varchanged_opt_floorplan', function(args) { me._floorplan_button.logicBlock_visible(); });
